...
@NgModule({
  declarations: [
    ExtractArrayValue //we need to shared this pipe
  ],
  imports: [
    RouterModule,//when ngviagte different route
    CommonModule, //BrowserModule is a super set of CommonModule, e.g, "ngIf, ngFor" need CommonModule
    FormsModule // e.g, ng Submit need FormsModule
  ],
  exports: [
    RouterModule,
    CommonModule,
