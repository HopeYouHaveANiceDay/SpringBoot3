...
// Since we need to use <app-navbar ...></app-navbar> in home page, so we need to export navbar
@NgModule({
  declarations: [ NavbarComponent ],
  imports: [ SharedModule ],
  exports: [ NavbarComponent ] // Since we need to use <app-navbar ...></app-navbar> in home page, so we need to export navbar
